        ...
        <div className="service-blogs">
          ...
          >
            ...
            <div className="info">
              ...
              <p>
                ...
                konularında rehberlik eder. Çeviri Hizmetleri, Sınav Hazırlık ve
                Destek, Burs Başvuru Yardımı, Vize Başvuru Desteği
              </p>
            </div>
            <div className="icon">
              <i>
          ...
          >
            ...
            <div className="info">
              ...
              <p>
                Ajans, iki ülke arasındaki akademik ve uzman personel değişimini
                destekler. Uzman transferi programları sayesinde, akademisyenler
                ve uzmanlar bilgi ve deneyimlerini paylaşarak eğitim kalitesini
                artırırlar
              </p>
            </div>
            <div className="icon">
          ...
          >
            ...
            <div className="info">
              ...
              <p>
                ...
                birliği fırsatlarını artırmak için danışmanlık hizmetleri sunar.
                Ortak projeler, müfredat geliştirme ve akademik değişim
