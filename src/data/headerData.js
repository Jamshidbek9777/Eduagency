    ...
    useEffect(() => {
        const fetchData = () => {
            const data = [
                ...
                { title: getText("headerSwiperTitle4"), description: getText("headerSwiperParagraph4"), desc2: getText("headerSwiperParagraph41"), headerLink: "/organization-services", bgImage: "/img/akademiktur2.jpg", mobBgImage: "/img/akademiktur2.jpg" },
