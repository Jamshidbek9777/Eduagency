    ...
    useEffect(() => {
        const fetchData = () => {
            const data = [
                ...
                { title: getText("headerSwiperTitle4"), description: getText("headerSwiperParagraph4"), headerLink: "/organization-services", bgImage: "/img/akademiktur.jpg", mobBgImage: "/img/akademiktur.jpg" },
