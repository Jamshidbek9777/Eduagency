export const tr = {
    ...
    WorkAndTravelTitle: "Work & Travel ile Almanya’da Hayatınızı Değiştirin!",
    WorkAndTravelParagraph: "Özbekistan’ın en güvenilir ve deneyimli Work and Travel firması olarak, gençlerimizi Almanya’ ye hem çalışmak hem de farklı kültürleri keşfetmek üzere gönderiyoruz.Her adımda yanınızda olarak, size güvenli, keyifli ve kazançlı bir yolculuk sunmayı hedefliyoruz.",
    WorkAndTravelAccordionTitle1: "Almanya’da Çalışmak ve Geleceğinize Yatırım Yapmak",
    ...
    WorkAndTravelAccordionParagraph1: "Work and Travel, sadece bir iş programı değildir; aynı zamanda hayatı farklı bir pencereden görmenizi sağlayan eşsiz bir fırsattır. Almanya’ de çalışarak para kazanırken, uluslararası iş tecrübesi edinir ve özgeçmişinize önemli bir katkı sağlarsınız.",
    WorkAndTravelAccordionParagraph11: "Almanyalı işverenler ve çalışanlarla kaynaşarak İngilizce dil becerilerinizi geliştirirsiniz.Bu süreç, gelecek kariyeriniz için altın bir basamak olacaktır.",
    WorkAndTravelAccordionParagraph2: "Almanya, dünya çapında birçok kültürün bir arada yaşadığı eşsiz bir ülkedir.Farklı kültürlerle iç içe olmak, Özbek misafirperverliği ve değerlerine olan bağlılığınızı dünya çapında tanıtma fırsatıdır.",
    WorkAndTravelAccordionParagraph3Strong1: "Deneyim ve Güven:",
    WorkAndTravelAccordionParagraph3Strong2: "Vize ve Seyahat Desteği:",
    WorkAndTravelAccordionParagraph3Strong3: " Almanya’de Destek Hattı:",
    WorkAndTravelAccordionParagraph3P1: "Yılların tecrübesine sahip firmamız, her yıl sayısız öğrenciyi güvenle Almanya’ ya göndermektedir.",
    ...
    WorkAndTravelAccordionParagraph3P3: "Almanya’da bulunduğunuz sürede de sizi yalnız bırakmıyoruz.",
    ...
    WorkAndTravelAccordionParagraph4P1: "Almanya’da çalışarak, hem kendi harcamalarınızı karşılayacak hem de birikim yapma şansına sahip olacaksınız. ",
    WorkAndTravelAccordionParagraph4P2: "Almanya, dünyanın en dinamik ve çeşitli ülkelerinden biridir. ",
    WorkAndTravelAccordionParagraph4P3: "Almanya’de elde edeceğiniz uluslararası iş deneyimi, gelecekteki kariyerinizde size büyük avantaj sağlayacaktır. ",
    ...
    WorkAndTravelEndTitle: "Almanya’da hem çalışmak hem de dünyayı keşfetmek için hazır mısınız?",
