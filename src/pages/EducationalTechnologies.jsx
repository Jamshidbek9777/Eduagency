...
const EducationalTechnologies = () => {
  ...
  return (
    <>
      <Helmet
        title={getText("headerSwiperTitle8")}
        description={metaDescription}
        link="/educational-technologies"
        keywords={metaKeywords}
      />

      <div className="service-pages">
        <div className="description container">
          <h1>{getText("headerSwiperTitle8")}</h1>
          <a href="https://www.turkosoft.uz/" target="_blank" rel="noopener noreferrer" className="styled-link">
...
export default EducationalTechnologies;
